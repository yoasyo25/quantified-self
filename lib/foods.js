...
function buildTable() {
    $.getJSON(api, function(data) {
      ...
      $.each( data, function( key, val ) {
          foods.push( "<tr><td data-editable id='" + key + "'>" + val['name'] + "</td><td data-editable id='" + key + "'>" + val['calories'] + "</td><td id='" + key + "'>" + "<button type='button' id='" + key + "' class='deleteButton'>-</button>" + "</td></tr>" );
        });
